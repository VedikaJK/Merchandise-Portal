...
public class ProductPurchase extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name.setText("Harshita Gupta");
        upiId.setText("theharshitagupta@okaxis");
        note.setText("APP TESTING");
        amount.setText("1");
        ...
        pay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!payerName.equals("") && !upiId.equals("") && !msgNote.equals("") && !sendAmount.equals("")){
                    ...
                    Toast.makeText(ProductPurchase.this,"Fill all above details and try again.", Toast.LENGTH_SHORT).show();
    ...
    private void payWithGpay(String packageName){
        ...
        if(isAppInstalled(this,packageName)){
            ...
            Toast.makeText(ProductPurchase.this,"Google pay is not installed. Please istall and try again.", Toast.LENGTH_SHORT).show();
        }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data){
        ...
        if ((RESULT_OK == resultCode) && status.equals("success")) {
            Toast.makeText(ProductPurchase.this, "Transaction successful.", Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(ProductPurchase.this, "Transaction cancelled or failed please try again.", Toast.LENGTH_SHORT).show();
